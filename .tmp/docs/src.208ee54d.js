parcelRequire = function (e, r, n, t) { var i = "function" == typeof parcelRequire && parcelRequire, o = "function" == typeof require && require; function u(n, t) { if (!r[n]) {
    ...
    "object" == typeof exports && "undefined" != typeof module ? module.exports = c : "function" == typeof define && define.amd ? define(function () { return c; }) : t && (this[t] = c);
            ...
            exports.default = t;
        }, {}], "6fRE": [function (require, module, exports) {
            "use strict";
            ...
            var e = require("./components/birthday-picker.js"), n = r(require("./components/icons.js")), t = require("./utils/date.js");
            function r(e) { return e && e.__esModule ? e : { default: e }; }
            const d = (e, n) => { const t = document.querySelector(".persons"); e.map(o).forEach(e => t.appendChild(e)), t.appendChild(p(n)); };
            exports.renderPersons = d;
            const o = e => { const t = document.createElement("div"); t.classList.add("person"), [i(e.name), c(e.birthday, e.age, e.daysToBirthday), s(e.seenBefore), ...l(e.customTexts)].filter(Boolean).forEach(e => t.appendChild(e)); const r = document.createElement("div"), d = document.createElement("div"); return r.classList.add("icon-edit", "icon"), d.classList.add("icon-remove", "icon"), r.addEventListener("click", e.handleEdit.bind(null, e.id)), d.addEventListener("click", e.handleRemove.bind(null, e.id)), r.innerHTML = n.default.edit, d.innerHTML = n.default.remove, t.appendChild(d), t.appendChild(r), t; }, i = e => { const n = a(e); return n.classList.add("person-title"), n; }, a = e => { const n = document.createElement("div"); return n.innerHTML = e, n; }, c = (e, n, r) => { if (!e)
                return null; const d = document.createElement("div"), o = (0, t.formatDMY)(e); return d.innerHTML = `Age: ${n}<br />Birthday in ${r} days (${o})`, d; }, s = e => { if (!e && 0 !== e)
                return null; const n = document.createElement("div"); document.createElement("button"); return n.innerHTML = `Seen before ${e} days`, n; }, l = e => e ? e.map(a) : [], u = () => { document.querySelector(".persons").innerHTML = ""; };
            exports.clearPersons = u;
            const p = n => { const t = document.createElement("div"), r = document.createElement("input"), [d, o, i] = (0, e.birthdayPicker)({ day: 1, month: 1, year: 1980 }), a = document.createElement("button"); return r.placeholder = "Name", a.innerText = "Save", a.addEventListener("click", () => { n(r.value, d.value, o.value, i.value); }), t.appendChild(r), t.appendChild(d), t.appendChild(o), t.appendChild(i), t.appendChild(a), t; };
        }, { "./components/birthday-picker.js": "ufb7", "./components/icons.js": "byH2", "./utils/date.js": "6fRE" }], "pIMj": [function (require, module, exports) {
            "use strict";
...
//# sourceMappingURL=/personas/src.208ee54d.map
